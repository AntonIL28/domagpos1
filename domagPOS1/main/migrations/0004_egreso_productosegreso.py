# Generated by Django 4.2.6 on 2023-12-22 01:02
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main', '0003_rename_dir_ciudad_cliente_dirciudad_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='clientee', to='main.cliente')),
            ],
            options={
                'verbose_name': 'egreso',
