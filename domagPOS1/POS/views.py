...
from POS.models import Article, Egreso, ProductosEgreso, Category, Stock
    ...
    def post(self, request,*ars, **kwargs):
        ...
        try:
            ...
            if action == 'autocomplete':
                data = []
                for i in Article.objects.filter(description__icontains=request.POST["term"])[0:10]:
                    item = i.toJSON()
...
"""def export_pdf_view(request, id, iva):
    ...
    css_url = os.path.join(settings.BASE_DIR,'main\static\css/style.css')
